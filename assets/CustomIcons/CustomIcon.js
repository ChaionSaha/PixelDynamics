...
export function CheckedIcon({ className }) {
    return (<svg className={className} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
            <clipPath id="clip0_1749_272">
                <rect className={className} fill="white" transform="translate(5 5)"/>
            </clipPath>
        </defs>
    </svg>
    )
...
export function CheckedCircleIcon({ className }) {
    return (
        <svg className={className} viewBox="0 0 115 115" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M85.5924 33.3113C83.8387 33.6081 84.81 32.7043 65.5871 51.9002L47.8211 69.6527L39.6868 61.5453C32.1595 54.0315 31.4985 53.411 30.7161 53.0738C28.2475 51.9946 25.3472 52.8444 23.8768 55.0703C23.2563 55.9876 23 56.8914 23 58.1189C23 59.306 23.2563 60.2098 23.8094 61.0732C24.0252 61.4104 28.8006 66.2937 34.4258 71.9054C45.5953 83.0615 45.0962 82.6298 47.0117 82.9266C48.1449 83.1154 49.1971 82.94 50.3707 82.4005C51.207 82.0093 52.3806 80.8626 71.1853 62.0579C90.3273 42.916 91.1232 42.0931 91.5548 41.1893C91.973 40.299 92 40.1641 92 38.7612C92 37.3852 91.973 37.2098 91.5818 36.4005C90.5161 34.1477 88.088 32.8931 85.5924 33.3113Z" fill="white"/>
        </svg>
    )
}
