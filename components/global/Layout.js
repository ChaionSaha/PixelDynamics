            ...
            </Head>
            {
                !router.pathname.includes('/admin/auth') ?
                    <>
                        ...
                        <div
                            className={`lg:w-[84%] w-full h-full duration-500 delay-150 overflow-y-auto  ${active ? 'translate-x-[70%] md:translate-x-[40%] lg:translate-x-0' : 'translate-x-0 lg:translate-x-0'} ${router.pathname.includes('/admin') ? 'bg-admin-primary text-base-200' : ''}`}>
